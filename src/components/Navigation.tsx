...
const Navigation = () => (
    <nav className="bg-white border-b pt-6 px-4 overflow-x-auto">
      <div className="flex items-center space-x-6 text-gray-500 min-w-max">
        <Link to="/" className="text-blue-600 pb-3 border-b-2 border-blue-600 flex items-center gap-x-1.5">
        ...
        <Link to="/" className="hover:text-blue-600 pb-3 flex items-center gap-x-1.5">
